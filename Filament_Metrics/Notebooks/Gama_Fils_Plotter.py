...
skeleton_file_dm = '/Users/Daniel/Documents/Research Projects/Cosmic Filaments/GAMA_filaments/GAMA_tess.NDnet_s5.up.NDskl.S002.BRK.ASMB.rmO.rmB.a.NDskl'
...
#x,y,z = fm.cp_plotter(peaks) ; ax.scatter(x,y,z, label = 'Nodes', s = 10, alpha = 0.5, c = 'tomato')
#x,y,z = fm.cp_plotter(bi_points) ; ax.scatter(x,y,z, label = 'Bi. Points', s = 10, alpha = 0.5, c = 'k')
#saddles
#x,y,z = fm.cp_plotter(saddles) ; ax.scatter(x,y,z, label = 'Saddles', s = 10, alpha = 0.4, c = 'darkturquoise')

ax.set_xlabel('X') ; ax.set_ylabel('Y') ; ax.set_zlabel('Z')
ax.set_title('Filaments created from GAMA Galaxies')
ax.legend()
plt.show()
